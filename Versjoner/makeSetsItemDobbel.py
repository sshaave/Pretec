...
#    i1.write('\t\t\t<item patch="18">5</item>\n')
    ...
    i1.write('\t\t\t<item patch="20">4</item>\n')
    i1.write('\t\t\t<item patch="21">4</item>\n')
    i1.write('\t\t\t<item patch="22">4</item>\n')
    i1.write('\t\t\t<item patch="23">4</item>\n')
    i1.write('\t\t\t<item patch="24">4</item>\n')
    i1.write('\t\t\t<item patch="25">4</item>\n')
    i1.write('\t\t\t<item patch="26">4</item>\n')
    i1.write('\t\t</set>\n')
    ...
    i1.write('\t\t</set>\n')
    i1.write('\t\t<set name="bunnplateMotBak" type="face">\n')
    i1.write('\t\t\t<item patch="15">2<\item>\n')
    i1.write('\t\t\t<item patch="20">2<\item>\n')
    i1.write('\t\t</set>\n')
    i1.write('\t\t<set name="stiverplate" type="face">\n')
    i1.write('\t\t\t<item patch="17">3</item>\n')
    i1.write('\t\t\t<item patch="18">3</item>\n')
    i1.write('\t\t\t<item patch="19">3</item>\n')
    i1.write('\t\t</set>\n')
