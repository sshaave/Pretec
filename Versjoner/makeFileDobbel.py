...
with open(name,'w') as i1:
    ...
    i1.write('" w="'+refW)
    i1.write('"/>\n')
    i1.write('\t<refine lowerpatch="9" upperpatch="12" w="2"/>\n')
    i1.write('\t<refine lowerpatch="17" upperpatch="18" w="2"/>\n')
    i1.write('\t<refine lowerpatch="22" upperpatch="24" w="2"/>\n')
    i1.write('\t<refine lowerpatch="20" v="4"/>\n')
    i1.write('\t<topology>\n')
    ...
    i1.write('\t<dirichlet set="b1" comp="123"/>\n')
    i1.write('\t<dirichlet set="b2" comp="123"/>\n')
    i1.write('\t<dirichlet set="b3" comp="123"/>\n')
    ...
    i1.write('<elasticity>\n')
    i1.write('\t<isotropic E="2.1e5" nu="0.3" rho="7.850e-6"/>\n')
    ...
    i1.write('\t<boundaryforce set="oppleggMotEnde"/>\n')
    i1.write('\t<boundaryforce set="bunnplateMotEnde"/>\n')
    i1.write('\t<boundaryforce set="bunnplateMotBak"/>\n')
    i1.write('\t<boundaryforce set="stiverplate"/>\n')
    i1.write('</elasticity>\n\n')
    i1.write('<!-- Post processing !-->\n')
    i1.write('<postprocessing>\n')
    i1.write('\t<hdf5/>\n')
    i1.write('<projection type="cgl2"/>\n')
    i1.write('</postprocessing>\n\n')
    i1.write('</simulation>')
