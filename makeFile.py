...
with open(name,'w') as i1:
    ...
    i1.write('" w="'+refW)
    i1.write('"/>\n')
    i1.write('\t<refine lowerpatch="9" upperpatch="10" w="3"/>\n')
    i1.write('\t<refine patch="15" w="3"/>\n')
    i1.write('\t<refine lowerpatch="13" v="5"/>\n')
    i1.write('\t<topology>\n')
...
#        i1.write('" face="2" edge="10"/>\n')
    ...
    i1.write('\t<boundaryforce set="bunnplateStiverplate"/>\n')
